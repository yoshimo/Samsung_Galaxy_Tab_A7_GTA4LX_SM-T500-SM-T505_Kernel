...
MMC_DEV_ATTR(life_time, "0x%02x 0x%02x\n",
	card->ext_csd.device_life_time_est_typ_a,
	card->ext_csd.device_life_time_est_typ_b);
MMC_DEV_ATTR(life_time_est_typ_a, "0x%02x\n",card->ext_csd.device_life_time_est_typ_a);//bug536971,zhaobeilong@wt,20200311,add life_time_a node
MMC_DEV_ATTR(life_time_est_typ_b, "0x%02x\n",card->ext_csd.device_life_time_est_typ_b);//bug536971,zhaobeilong@wt,20200311,add life_time_b node
...
//bug536971, zhaobeilong@wt,add,20200311,add flash_name node,start
...
//bug536971, zhaobeilong@wt,add,20200311,add flash_name node,end
...
static struct attribute *mmc_std_attrs[] = {
	...
	&dev_attr_life_time_est_typ_a.attr,      //bug536971,zhaobeilong@wt,20200311,add life_time_a node
	&dev_attr_life_time_est_typ_b.attr,      //bug536971,zhaobeilong@wt,20200311,add life_time_b node
	...
	&dev_attr_rca.attr,
	&dev_attr_dsr.attr,
	&dev_attr_flash_name.attr, //bug536971 , zhaobeilong@wt,add,20200311,add flash_name node
