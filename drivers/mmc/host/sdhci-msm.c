...
#include "cqhci.h"
#include <linux/proc_fs.h>		//bug542878, zhaobeilong@wt, 20200327, add sdcard slot check node
...
static int sdhci_irq_gpio = 0;		//bug542878, zhaobeilong@wt, 20200327, add sdcard slot check node
						...
						struct sdhci_msm_host *msm_host)
{
	...
	sdhci_irq_gpio = pdata->status_gpio;			//bug542878, zhaobeilong@wt, 20200327, add sdcard slot check node
...
//bug542878, zhaobeilong@wt, 20200327, add sdcard slot check node, start
...
//bug542878, zhaobeilong@wt, 20200327, add sdcard slot check node, end
...
static int sdhci_msm_probe(struct platform_device *pdev)
{
	...
	//msm_host->mmc->caps2 |= MMC_CAP2_CLK_SCALE;	//bug558453,zhaobeilong@wt, 20200523, modify, disable mmc clk scale feature
