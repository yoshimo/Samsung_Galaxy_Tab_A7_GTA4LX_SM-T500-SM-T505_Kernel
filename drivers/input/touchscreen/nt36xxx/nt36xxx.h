...
#define NVT_VENDOR_UPGRADE
#ifdef NVT_VENDOR_UPGRADE
extern char nvt_fw_name[64];
extern char nvt_mp_name[64];
#define BOOT_UPDATE_FIRMWARE_NAME nvt_fw_name
#define MP_UPDATE_FIRMWARE_NAME nvt_mp_name
#else
