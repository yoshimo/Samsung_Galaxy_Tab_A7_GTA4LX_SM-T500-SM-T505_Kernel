...
{
	sec_debug_strcpy_task_comm(msg->comm, current->comm);
...
/* BLOCK this code for skipping build error warning: unused function 'print_task_info' [-Wunused-function]
error, forbidden warning: printk.c:1306
