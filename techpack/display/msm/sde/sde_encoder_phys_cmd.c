		...
		struct sde_encoder_phys *phys_enc)
{
	...
	struct sde_kms *sde_kms;//bug556433,sijun.wt,2020/0514,modify code to resolve memory leaks
	int ret = 0;
	...
	sde_kms = phys_enc->sde_kms;//bug556433,sijun.wt,2020/0514,modify code to resolve memory leaks
